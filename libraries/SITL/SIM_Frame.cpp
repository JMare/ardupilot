...
{
    //chan 9 and 10
    Motor(AP_MOTORS_MOT_1,  90, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 2, -1, 0, 0, AP_MOTORS_MOT_5, 90, -90),
    Motor(AP_MOTORS_MOT_2, -90, AP_MOTORS_MATRIX_YAW_FACTOR_CW, 4, -1, 0, 0, AP_MOTORS_MOT_6, 90, -90),
    Motor(AP_MOTORS_MOT_3,   0, 0,  1),
    Motor(AP_MOTORS_MOT_4, 180, 0,  3)
};
